...
export class Correspondence extends events.EventEmitter {
  ...
  */
  ...
  /**
  * @summary Convert to write-only correspondence.
  *
  * @description This method will return a write-only proxy to this instance.
  *
  * @returns {WritableCorrespondence} Write-only correspondence
  */
  // TODO: Test
  asWritable () {
    ...
    return this.#makeProxy(writable)
  }

  /**
  * @summary Convert to read-only correspondence.
  *
  * @description This method will return a read-only proxy to this instance.
  *
  * @returns {ReadableCorrespondence} Read-only correspondence
  */
  // TODO: Test
  asReadable () {
    ...
    return this.#makeProxy(readable)
  }
